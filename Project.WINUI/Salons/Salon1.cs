...
namespace Project.WINUI
{
    public partial class Salon1 : Form
    {
        ...
        int _employeeID;
        int _salonNo;
        public Salon1(int employeeID, string movieName,int salonNo)
        {
            InitializeComponent();
        ...
        private void TicketSelect(object sender, int eId, ComboBox session, DateTimePicker picker, TicketRepository _tRep)
        {
            ...
            {
                if (session.Text == "11:00" && DateTime.Now > new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.Day, 11, 0, 0) && picker.Value.Day == DateTime.Today.Day) //Saat 11 den sonra 11 seansına randuvu alınmasını onleme 
                {
                    MessageBox.Show("You can't sell ticket after the movie starts.");
                    return;
                }
                else if (session.Text == "14:00" && DateTime.Now > new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.Day, 14, 0, 0) && picker.Value.Day == DateTime.Today.Day)//Saat 14 den sonra 11 seansına randuvu alınmasını onleme 
                {
                    MessageBox.Show("You can't sell ticket after the movie starts.");
                    return;
                }
                else if (session.Text == "17:00" && DateTime.Now > new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.Day, 17, 0, 0) && picker.Value.Day == DateTime.Today.Day)//Saat 17 den sonra 11 seansına randuvu alınmasını onleme 
                {
                    MessageBox.Show("You can't sell ticket after the movie starts.");
                    return;
                }
                else if (session.Text == "20:00" && DateTime.Now > new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.Day, 20, 0, 0) && picker.Value.Day == DateTime.Today.Day)//Saat 20 den sonra 11 seansına randuvu alınmasını onleme 
                {
                    MessageBox.Show("You can't sell ticket after the movie starts.");
                    return;
                }
